  ...
  const trainers = [
    {
      ...
      image: "/images/trainer-1.svg", // matches your file structure
      social: {
    ...
    },
    {
      ...
      image: "/images/trainer2.svg", // matches your file structure
      social: {
    ...
    },
    {
      ...
      image: "/images/trainer3.svg", // matches your file structure
      social: {
    ...
    },
    {
      ...
      image: "/images/trainer4.svg", // matches your file structure
      social: {
        ...
        <div className=" mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {trainers.map((trainer) => (
              <article
                key={trainer.id}
                className="gymfolio7-trainer-card rounded-lg overflow-hidden group cursor-pointer"
              >
